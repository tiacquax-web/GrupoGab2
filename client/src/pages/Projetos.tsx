      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Acompanhe o andamento de obras e projetos com Kanban
          </p>
        </div>
            ...
            >
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  placeholder="Ex: Obra Residencial Silva..."
                />
              </div>
              <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <Select
                    ...
                    onValueChange={v => setProjectValue("status", v)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    defaultValue="media"
                    onValueChange={v => setProjectValue("priority", v)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Select
                    onValueChange={v =>
                      setProjectValue("costCenterId" as any, parseInt(v))
                    }
                  >
                    <SelectTrigger>
            ...
            >
              <CardContent className="p-4 space-y-2">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <Badge
                    className={`text-xs border ${projectStatusConfig[project.status]?.color}`}
                  >
          ...
          {!selectedProject ? (
            ...
            <>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1.5">
                          ...
                          <Select
                            ...
                            onValueChange={v => setTaskValue("status", v)}
                          >
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
                        ...
                        <div className="space-y-1.5">
                          ...
                          <Select
                            defaultValue="media"
                            onValueChange={v => setTaskValue("priority", v)}
                          >
                            <SelectTrigger>
                              <SelectValue />
                            </SelectTrigger>
              ...
              <div className="grid grid-cols-2 xl:grid-cols-4 gap-3">
                {Object.entries(taskStatusConfig).map(
                  ([status, config]: any) => {
                    const statusTasks = (tasks as any[]).filter(
                      (t: any) => t.status === status
                    );
                    return (
                      <div key={status} className="space-y-2">
                        <div
                          className={`flex items-center gap-2 p-2.5 rounded-lg border-t-2 bg-card ${config.color}`}
                        >
                                ...
                                <div className="flex gap-1">
                                  {getNextStatus(task.status) && (
                                    <Button
                                      size="sm"
                                      variant="outline"
                                      className="flex-1 h-6 text-[10px] gap-0.5"
                                      onClick={() =>
