              ...
              <Avatar className="h-9 w-9">
                <AvatarFallback className="text-xs">
                  {selectedConvData?.isGroup ? (
                    ...
                    initials(selectedConvData?.name)
                  )}
                </AvatarFallback>
              </Avatar>
              <div>
                <p className="font-semibold text-sm">
                  {selectedConvData?.name || "Conversa"}
                </p>
                <p className="text-xs text-muted-foreground">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        className={`px-3 py-2 rounded-2xl text-sm ${isMe ? "bg-primary text-primary-foreground rounded-tr-sm" : "bg-accent rounded-tl-sm"}`}
                      >
                        {msg.content}
                      </div>
