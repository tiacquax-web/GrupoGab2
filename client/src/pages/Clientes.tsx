              ...
              <div className="space-y-4 pt-2">
                <div className="p-3 rounded-lg bg-muted/30 text-xs text-muted-foreground space-y-1">
                  ...
                  <code className="block">
                    nome,tipo,email,telefone,documento,empresa,cidade,estado
                  </code>
                </div>
                <div className="space-y-1.5">
                  ...
                  <Textarea
                    ...
                    rows={8}
                    placeholder="nome,tipo,email,telefone..."
            ...
            <CardContent className="p-4 space-y-3">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex flex-col gap-1 items-end">
                  <Badge
                    className={`text-xs border ${statusConfig[client.status]?.color}`}
                  >
                    {statusConfig[client.status]?.label}
                  </Badge>
                  <Badge
                    className={`text-xs ${typeConfig[client.type]?.color}`}
                  >
