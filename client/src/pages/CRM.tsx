...
export default function CRM() {
  ...
  const onSubmit = (data: any) =>
    createMutation.mutate({ ...data, value: data.value || undefined });
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input
                    {...register("assignedToName" as any)}
          ...
          {STAGES.map(stage => {
            ...
            return (
              <div key={stage.key} className="w-64 shrink-0 space-y-3">
                <div
                  className={`flex items-center gap-2 p-3 rounded-lg border-t-2 bg-card ${stage.color}`}
                >
                ...
                <div className="space-y-2 min-h-32">
                  ...
                  {stageLeads.map((lead: any) => (
                    <Card
                      key={lead.id}
                      className="border-border hover:border-primary/30 transition-colors cursor-default"
                    >
                      <CardContent className="p-3 space-y-2">
                        <div className="flex items-start justify-between">
                          ...
                          <span
                            className={`text-xs font-medium ${priorityColors[lead.priority]}`}
                          >
                            ●
                          </span>
                        </div>
                        ...
                        {lead.value && (
                          <p className="text-xs font-medium text-emerald-400">
                            R${" "}
                            {parseFloat(lead.value).toLocaleString("pt-BR", {
                            ...
                            <Button
                              ...
                              onClick={() =>
                                updateStageMutation.mutate({
                                  id: lead.id,
                                  stage: getNextStage(lead.stage) as any,
                                })
                              }
                            >
