...
export default function Documentos() {
  ...
  const { data: documents = [], refetch } = trpc.documents.list.useQuery({
    relatedType: filterType !== "all" ? filterType : undefined,
    search,
  });
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Gerencie todos os arquivos e documentos da empresa
          </p>
        </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <Select value={relatedType} onValueChange={setRelatedType}>
                    ...
                    <SelectContent>
                      {Object.entries(relatedTypeConfig).map(([k, v]: any) => (
            ...
            >
              <CardContent className="p-4 space-y-3">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  <Badge
                    className={`text-xs ${relatedTypeConfig[doc.relatedType]?.color}`}
                  >
                    {relatedTypeConfig[doc.relatedType]?.label}
                  </Badge>
                  {doc.category && (
                ...
                <p className="text-xs text-muted-foreground">
                  Por: {doc.uploadedByName || "Sistema"}
                </p>
