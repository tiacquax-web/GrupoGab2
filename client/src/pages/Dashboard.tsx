...
const kpiCards = [
  ...
  },
  {
    ...
    path: "/projetos",
    detail: "2 com prazo crítico",
  },
];

const recentActivities = [
  {
    text: "Conta de fornecedor vencendo amanhã",
    value: "R$ 3.200",
    urgent: true,
  },
  {
    text: "Pagamento recebido - Cliente Silva",
    value: "R$ 8.500",
    urgent: false,
  },
  {
    text: "Novo lead: Construtora Horizonte",
    value: "R$ 45.000",
    urgent: false,
  },
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm mt-1">
            Resumo operacional do Grupo GAB —{" "}
        ...
        <Badge
          variant="outline"
          className="text-xs px-3 py-1.5 border-primary/30 text-primary"
        >
          Sistema Ativo
        </Badge>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        {kpiCards.map(kpi => (
          <Card
            key={kpi.title}
            className={`border ${kpi.borderColor} hover:bg-accent/30 transition-all cursor-pointer group`}
              ...
              >
                <defs>
                  <linearGradient id="colorPagar" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#e07040" stopOpacity={0.3} />
                    <stop offset="95%" stopColor="#e07040" stopOpacity={0} />
                  </linearGradient>
                  <linearGradient id="colorReceber" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#40b080" stopOpacity={0.3} />
                    <stop offset="95%" stopColor="#40b080" stopOpacity={0} />
                  </linearGradient>
                </defs>
                <CartesianGrid
                  strokeDasharray="3 3"
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            {recentActivities.map((a, i) => (
              ...
              >
                <div
                  className={`w-2 h-2 rounded-full shrink-0 ${a.urgent ? "bg-red-400" : "bg-emerald-400"}`}
                />
            ...
            <div className="grid grid-cols-2 gap-2">
              {quickActions.map(action => (
                <Button
                  key={action.label}
                  variant="outline"
                  className="h-auto py-3 px-3 flex items-center gap-2.5 justify-start hover:bg-accent/50 border-border text-left"
