        ...
        <Dialog open={openNew} onOpenChange={setOpenNew}>
          ...
          <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  <Label>Destinado a (Pessoa)</Label>
                  <Input
                    {...register("destinedToName")}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input {...register("expectedDate")} type="date" />
                </div>
              </div>
              <div className="space-y-1.5">
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="space-y-2 flex-1">
                  <div className="flex items-center gap-3">
                    ...
                    <Badge
                      className={`text-xs border ${statusConfig[order.status]?.color}`}
                    >
                  ...
                  <div className="flex flex-wrap gap-4 text-xs text-muted-foreground">
                    ...
                    {order.destinedToName && (
                      <span className="flex items-center gap-1">
                        <User className="h-3 w-3" />
                        Para: {order.destinedToName}
                      </span>
                    )}
                    {order.sector && (
                      <span className="flex items-center gap-1">
                    ...
                    {order.expectedDate && (
                      <span>
                        Entrega: {formatDate(order.expectedDate as string)}
                      </span>
                    )}
                  </div>
                </div>
