...
const MODULES = [
  {
    key: "financeiro",
    label: "Financeiro",
    description: "Contas a pagar, receber e centro de custo",
  },
  {
    key: "clientes",
    label: "Clientes",
  ...
  { key: "agenda", label: "Agenda", description: "Compromissos e eventos" },
  {
    ...
    description: "Kanban de engenharia",
  },
  {
    key: "documentos",
    label: "Documentos",
...
export default function AdminPermissions() {
  ...
  const { data: permissions = [], refetch: refetchPerms } =
    trpc.admin.getPermissions.useQuery(
  ...
  const getPermForModule = (moduleKey: string) => {
    const perm = (permissions as any[]).find(
          ...
          {!selectedUserId ? (
            ...
            <>
              <div className="flex items-center gap-2 mb-4">
                ...
                <Badge className="ml-auto bg-blue-500/15 text-blue-400 border border-blue-500/30 text-xs">
                  user
                </Badge>
              </div>
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <div
                          className={`h-2 w-2 rounded-full ${perm.canView ? "bg-emerald-400" : "bg-zinc-600"}`}
                        />
                      ...
                      <div className="flex items-center gap-2">
                        <Badge className="text-xs bg-muted/50">
                          {activeCount}/4 permissões
                        </Badge>
                        {isExpanded ? (
