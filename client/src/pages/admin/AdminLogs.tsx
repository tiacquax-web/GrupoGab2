...
export default function AdminLogs() {
  ...
  const [status, setStatus] = useState<"all" | "success" | "error" | "warning">(
    "all"
  );
            ...
            {(logs as any[]).map((log: any) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <Badge className="text-[10px] bg-muted/50 border border-border capitalize">
                      {log.module}
                    </Badge>
                  </td>
                  <td className="px-4 py-3">
                    <code className="text-[10px] bg-muted/40 px-1.5 py-0.5 rounded font-mono">
                      {log.action}
                    </code>
                  </td>
                  <td
                  ...
                  <td className="px-4 py-3">
                    <Badge
                      className={`text-[10px] border gap-1 ${statusCfg.color}`}
                    >
